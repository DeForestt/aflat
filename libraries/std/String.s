...
pub_String_isNumeric:
	...
	movq	%rax, %rdi
	pushq	%rsi
	movq	$lambda_1649254104024_0, %rax
	movq	%rax, %rsi
	lea	-9(%rbp), %rax
	pushq	%rdx
	movq	%rax, %rax
...
pub_String_del:
	...
	pushq	%rdx
	pushq	%rdi
	movq	$.strString.lambda_1649254104024_02, %rax
	movq	%rax, %rdi
	movq	$0, %rsi
	call	io.print
	popq	%rdi
...
pub_String_toInt:
	...
	pushq	%rdx
	pushq	%rdi
	movq	$.strString.lambda_1649254104024_026, %rax
	movq	%rax, %rdi
	call	panic
	popq	%rdi
	popq	%rdx
...
.strString.lambda_1649254104024_026:
	.asciz	 "Attempt to convert non-numeric string to int"
.strString.lambda_1649254104024_02:
	.asciz	 "delete\n"
